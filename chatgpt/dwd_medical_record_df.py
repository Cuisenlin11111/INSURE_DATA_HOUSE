...
from claim_prd.clm_case_image_track  where  IMAGE_TYPE='03'  and  C_APP_NO is not null  and  INSURE_COMPANY_CHANNEL='CP08' and substr(CREATE_TIME,1,7)='2024-10'
...
try:
    ...
    with connection.cursor() as cursor:
        ...
        sql = "INSERT INTO CLAIM_DWD.dwd_medical_record_df (`C_APP_NO`, `url`, `text`,`DATA_DT`) VALUES (%s, %s, %s,%s)"
        batch = []
