        ...
        with conn.cursor() as cursor:
            ...
            if results:
                ...
                alert_message = alert_message_template.format(
                    ...
                    异常渠道列表=" ".join(
                        [row.get('INSURE_COMPANY_CHANNEL') for row in results if row.get('INSURE_COMPANY_CHANNEL')])
                )
...
if __name__ == "__main__":
    ...
    config_file_path = os.path.join(os.path.dirname(__file__), 'check_config.ini')
