...
WITH
    hh AS (
        SELECT
            ...
            END AS 单价
        FROM CLAIM_DWD.DWD_TK_BILL_DETAIL
    ...
    t2 AS (
        SELECT
            ...
            C_INV_NO,
            CASE
                WHEN MEDICAL_TYPE = '门诊' AND is_back = '结案' THEN 8
                WHEN MEDICAL_TYPE = '门诊' AND is_back = '撤案' THEN 4
                WHEN MEDICAL_TYPE = '住院' AND is_back = '结案' THEN 16
                WHEN MEDICAL_TYPE = '住院' AND is_back = '撤案' THEN 8
                ELSE 0
            END AS PRICE_DJ,
