...
on aa.DT_MONTH=bb.DT_MONTH)
      SELECT
       ...
       cast(191925 *  t2.项目作业人数 / (13.5 + 8 +10 + t2.项目作业人数)  as decimal(10,2))  意健TPA慧理赔管理公摊月,
       cast((191925 *  t2.项目作业人数 / (13.5 + 8 +10 + t2.项目作业人数) ) /回传案件量 as decimal(10,2)) 意健TPA慧理赔管理公摊案件,
       cast(434833 *   ( 22+ t2.项目作业人数 ) / (130-54 + t2.项目作业人数) as decimal(10,2))   意健TPA公司管理公摊月,
       cast((434833 * ( 22+ t2.项目作业人数 )/ (130-54 + t2.项目作业人数) ) /回传案件量 as decimal(10,2)) 意健TPA公司管理公摊案件,
       REPLACE(CURDATE(),'-','')
    FROM cc t2
"""
